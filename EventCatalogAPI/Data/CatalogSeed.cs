        ...
        private static IEnumerable<Event> GetPreConfigeredEvents()
        {
            return new List<Event>()
            {
                ...
                // new Event() {EventCategoryId=5, EventSubCatagoryId=7,  Location= "WA" , EventName = "Club Sur",Description = "Dark, intimate nightclub with a goth/industrial atmosphere, open to members & their guests.", EventStartDate = "12/1/2018", EventEndDate="12/1/2018", EventStartTime = "8PM", EventEndTime="12am", Fee= 29, Address= "4441 4st Ave S, Seattle, WA 98741",Created="10/12/2018", EventImageUrl= "http://externalcatalogbaseurltobereplaced/api/Pic/6" },
                 new Event() {EventCategoryId=6, EventSubCatagoryId=1,  Location= "WA" ,EventName = "Yoga and Dance class",Description = "Complete dance class", EventStartDate = "11/12/2018", EventEndDate="3/1/2019", EventStartTime = "8PM", EventEndTime="10pm", UnitPrice= 59, Address= "1124 25st Ave W, Seattle, WA 98547",Created="10/12/2018", EventImageUrl= "http://externalcatalogbaseurltobereplaced/api/Pic/20" },
                 new Event() { EventCategoryId=7, EventSubCatagoryId=7, Location= "WA" , EventName = "football Event",Description = "Man vs Ars", EventStartDate = "4/4/2019", EventEndDate="4/4/2019", EventStartTime = "8PM", EventEndTime="10pm", UnitPrice= 42, Address= "7711 3st Ave N, Seattle, WA 98564",Created="10/12/2018", EventImageUrl= "http://externalcatalogbaseurltobereplaced/api/Pic/10" }
            };
